...
Powered by a custom-trained model (PrivacyGuard) to blur:
...
Download your trained models from Roboflow/Ultralytics format and place them in:
...
Depth estimation for severity scoring
