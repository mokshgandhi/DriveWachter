...
* **1. PotholeWächter – Pothole Segmentation Model**
    * Dataset + Model: [https://app.roboflow.com/drivewachter/potholewachter-yjrxy/models](https://app.roboflow.com/drivewachter/potholewachter-yjrxy/models)

* **2. PrivacyGuard – Sensitive Information Blur Model**
    * Dataset + Model: [https://app.roboflow.com/drivewachter/privacyguard-zo4qz/models](https://app.roboflow.com/drivewachter/privacyguard-zo4qz/models)

* **Roboflow Workspace (DriveWächter)**
    * All datasets and experiments: [https://app.roboflow.com/drivewachter](https://app.roboflow.com/drivewachter)
